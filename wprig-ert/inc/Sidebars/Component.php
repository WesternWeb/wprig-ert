...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	/**
	 * Checks whether the footer widgets sidebar is active.
	 *
	 * @return bool True if the footer widgets sidebar is active, false otherwise.
	 */
	...
	/**
	 * Displays the footer widgets sidebar.
	 */
